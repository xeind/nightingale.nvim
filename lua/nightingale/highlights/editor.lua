...
function M.setup(theme, config)
    ...
    return {
        ...
        LineNr = { fg = theme.ui.cursor_line_nr_foreground, bg = transparent and theme.ui.none or theme.ui.bg_gutter },
        CursorLineNr = { fg = theme.ui.cursor_line_nr_active_foreground, bg = transparent and theme.ui.none or theme.ui.bg_gutter, bold = true },
