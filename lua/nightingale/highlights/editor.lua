...
function M.setup(theme, config)
    ...
    return {
        ...
        CursorLine = { bg = transparent and theme.ui.none or theme.ui.bg_p1 },
        ...
        LineNr = { fg = theme.ui.cursor_line_nr_foreground, bg = transparent and theme.ui.none or theme.ui.bg },
        CursorLineNr = { fg = theme.ui.cursor_line_nr_active_foreground, bg = transparent and theme.ui.none or theme.ui.bg, bold = true },
