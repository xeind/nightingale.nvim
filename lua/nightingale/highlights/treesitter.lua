...
function M.setup(theme, config)
	...
	["@constructor.tsx"] = { fg = theme.syn.tag },
	["@constructor.javascript"] = { fg = theme.syn.tag },
	...
	["@punctuation.special.markdown"] = { fg = theme.syn.special1 },
	...
	["@tag.tsx"] = { fg = theme.syn.tag },
	["@tag.javascript"] = { fg = theme.syn.tag },
	["@tag.delimiter.tsx"] = { fg = theme.syn.tag_delimiter },
	["@tag.delimiter.javascript"] = { fg = theme.syn.tag_delimiter },
